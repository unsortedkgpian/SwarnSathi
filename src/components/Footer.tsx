    ...
    return (
        <div className="footer-section">
            <div className="container">
                <div
                    className="row cus-mar pt-120 pb-120 justify-content-between wow fadeInUp"
            ...
            <div className="img-area">
                ...
                {/* <img 
          src="https://swarnsathi.com/images/footer-Illu-left.png" 
          className="left" 
          alt="Images" 
        />
        <img 
          src="https://swarnsathi.com/images/footer-Illu-right.png" 
          className="right" 
          alt="Images" 
        /> */}
            </div>
